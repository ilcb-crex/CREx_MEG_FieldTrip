function mesh = spm_eeg_inv_mesh_hdmYH(sMRI, Msize)
...
%%% Tragus positioning is slightly different at Marseille MEG center laboratory
% So are the tragus fiducials definition for the template
% single_subj_T1.nii using here by SPM 

%%%% Depending on which template is used !??
fid = struct('fid', struct('pnt',[],'label',[]));
fid.fid.pnt = [     1   82.5  -43
                   -88  -24.5  -54
                    89 -23.5  -56
                   -87  -11  -62
                    87  -11  -62 ] ;
