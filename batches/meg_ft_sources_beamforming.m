...
prestim = 0; %-0.3;
% Template (= MRI in FiledTrip structure) should be found inside ft_CREx toolbox 
% inside meg/template 
template_name = 'template_Colin27_BS.mat'; 
...
if doVolCond==1
    ...
    % Initial grid is the same for all subjets before adjustment
